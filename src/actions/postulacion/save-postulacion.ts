...
const formSchema = z.object({
  ...
  worksFromHome: z.string().trim().optional(),
  moveDateNeeded: z.string().trim().optional(),
  creditBureauReported: z.string().trim().optional(),
...
export async function savePostulacion(
  ...
  const parsed = formSchema.safeParse({
    ...
    worksFromHome: formData.get("worksFromHome") ?? "",
    moveDateNeeded: formData.get("moveDateNeeded") ?? "",
    creditBureauReported: formData.get("creditBureauReported") ?? "",
  ...
  try {
    const application = await prisma.postulacionApplication.upsert({
      ...
      create: {
        ...
        currentOccupation: emptyToNull(fields.currentOccupation),
        employmentType: emptyToNull(fields.employmentType),
        worksFromHome: emptyToNull(fields.worksFromHome),
        moveDateNeeded: emptyToNull(fields.moveDateNeeded),
        creditBureauReported: emptyToNull(fields.creditBureauReported),
